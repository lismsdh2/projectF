...
import Enrollment.EnrollmentPopup.EnrollmentPopupController1;
...
public class EnrollmentController1 implements Initializable{
...
//	private Stage enrollmentStage;				//현재로서는 필요 없는 부분이지만, 전체 연동 시 필요 함
	...
	private EnrollmentPopupController1 popupController = new EnrollmentPopupController1(this);
	
	public EnrollmentController1() {
...
//	}
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		tableView.setOnMouseClicked(e -> handleDoubleClicked(e));
	}
	...
	private void addButton() {
		...
		colClassEnroll.setCellFactory(cellFactory);
